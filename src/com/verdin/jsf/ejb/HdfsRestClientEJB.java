...
import com.verdin.jsf.hdfs.Config;
import com.verdin.jsf.hdfs.Configuration;
import com.verdin.jsf.hdfs.Item;
import com.verdin.jsf.hdfs.JsonHdfs;

import org.jboss.logging.Logger;

@ApplicationScoped

public class HdfsRestClientEJB {

	static Logger logger = Logger.getLogger(HdfsRestClientEJB.class);
	   ...
	   */
	    	...
	    	// curl -u admin:admin -H "X-Requested-By: ambari" -X GET  http://192.168.3.221:8080/api/v1/clusters/H2SO4/configurations?type=hive-site
	     	...
	     	String URL_SECURED_BASIC_AUTHENTICATION = 
	     			"http://192.168.3.132:8080/api/v1/clusters/YAVA30/configurations/service_config_versions/?service_name=HDFS";
		...
		//		"http://192.168.3.221:8080/api/v1/clusters/H2SO4/configurations/service_config_versions/?service_name=xxxxxxxx";
	      ...
	      if (entity != null) {
	          ...
	          if(jsonTree.isJsonObject()){
	         	    ...
	         	    _hdfs.setHref(href.getAsString());
	         	  //  _hdfs.setItems(items);
	         	    ...
	         	    //   _item.setCreatetime(j.get("createtime").getAsString());
	         	     ...
	         	     //  System.out.println("configurations size " +_confs.size());
	         	       ...
	         	       for (JsonElement _json_e : _confs) {
	         	    	 ...
	         	    	 //  Config
	         	    	 //  type		: "hdfs-atlas-application-properties",
