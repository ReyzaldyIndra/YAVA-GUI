...
@Named
@ViewScoped
public class SqoopView implements Serializable {
	
	static final long serialVersionUID = 1237l;
	
	static Logger logger = Logger.getLogger(SqoopView.class);
	...
	static String DEFAULT_SERVICE = "SQOOP";
	...
	public  void init() throws Exception {
		...
		AmbariRestClient _client  =  new AmbariRestClient(HOSTNAME, CLUSTER);
		 ...
		 config = getCurrentConfigurationByType("sqoop-site");
