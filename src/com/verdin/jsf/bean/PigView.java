...
@Named
@ViewScoped
public class PigView implements Serializable {
	
	static final long serialVersionUID = 1237l;
	
	static Logger logger = Logger.getLogger(PigView.class);
	...
	static String DEFAULT_SERVICE = "PIG";
	...
	public  void init() throws Exception {
		...
		AmbariRestClient _client  =  new AmbariRestClient(HOSTNAME, CLUSTER);
		 ...
		 config = getCurrentConfigurationByType("pig-site");
